...
import com.levemus.gliderwaypoint.WifiDirect.Operations.WifiDirectOperationConfig;
import com.levemus.gliderwaypoint.WifiDirect.Operations.WifiDirectReceiveFile;
import com.levemus.gliderwaypoint.WifiDirect.Operations.WifiDirectSendFile;
...
public class WifiDirectServiceThread extends ServiceProviderThread implements WifiP2pManager.ChannelListener,
    ...
    public void run() {
        ...
        try {
            ...
            mParent.registerReceiver(mReceiver, mIntentFilter, null, mLocalHandler);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    protected void onRequest(SerializablePayloadMessage message) {
        WifiDirectRequestMessage request = (WifiDirectRequestMessage)message;
