...
import com.levemus.gliderwaypoint.Messages.ServiceMessages.ServiceEvent;
import com.levemus.gliderwaypoint.Messages.ServiceMessages.ServiceEventMessage;
...
public abstract class MessageService extends Service implements IMessageService {
    ...
    public void start(final Activity activity, Class service, UUID id) {
        ...
        String key = activity.getString(com.levemus.gliderwaypoint.R.string.service_id);
